...
$string['settings:type_help'] = 'Please chose whether you want to send email or sms only or both';
$string['settings:twiliosid'] = 'Twilio account SID';
$string['settings:twiliosid_help'] = 'Use ACCOUNt SID from your account dashboard';
$string['settings:twiliotoken'] = 'Twilio AUTH TOKEN';
$string['settings:twiliotoken_help'] = 'Use AUTH TOKEN from your account dashboard';
$string['settings:twiliophone'] = 'Twilio Phone number';
$string['settings:twiliophone_help'] = 'Use twilio phone number from https://www.twilio.com/console';
$string['settings:emailonly'] = 'Email only';
$string['settings:smsonly'] = 'SMS only';
$string['settings:emailandsmsboth'] = 'Email and SMS both';
...
$string['verificationcode'] = '<h4>Enter verification code for confirmation</h4>';
$string['verificationcode_help'] = 'Verification code has been sent';
$string['summarycondition'] = 'has valid email setup';
$string['email:message'] = 'You are trying to log in to {$a->siteurl}. Your confirmation code is \'{$a->secret}\'.';
$string['email:revokelink'] = '';
$string['email:geoinfo'] = '';
$string['resentemail'] = 'Verification code has been sent.';
$string['textmessage'] = 'Your login verification code is {$a->secret}';
